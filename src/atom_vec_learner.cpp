...
AtomVecLearner::AtomVecLearner(LAMMPS *lmp) : AtomVec(lmp)
{
  ...
  fields_create = { "poidsnn","dpoids", "qreward", "dreward", "lightintensity", "clock"};
  fields_exchange = { "poidsnn", "dpoids", "qreward", "dreward", "lightintensity", "clock"};
  ...
  fields_border = { "poidsnn", "dpoids", "qreward","dreward", "lightintensity", "clock"};
